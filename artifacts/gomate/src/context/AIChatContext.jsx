...
// Single source of truth for the Edge Function URL.
// We always hit the hosted Supabase project — there's no local
// supabase running in dev, so localhost would just fail.
const FUNCTION_URL =
      ...
      setMessages([
        {
          role: 'assistant',
          content:
            "Hi! I'm GoMate. I'm here to help you navigate the chaos of moving abroad. Where are we off to?",
